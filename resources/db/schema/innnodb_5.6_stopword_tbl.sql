...
table.  Because of this, it is recommended you import this table into the mysql database, NOT newzflash.  Do this with the following command (using an account that has access to the mysql database):
